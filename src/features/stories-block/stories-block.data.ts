...
export const stories: ComponentProps<typeof StoriesCard>[] = [
  {
    ...
    poster: {
      url: IrinaPoster.src,
      alt: "",
      width: IrinaPoster.width,
      height: IrinaPoster.height,
    },
    videoUrl: IrinaVideo,
  },
  {
    ...
    poster: {
      url: LilyPoster.src,
      alt: "",
      width: LilyPoster.width,
      height: LilyPoster.height,
    },
    videoUrl: IrinaVideo,
  },
  {
    ...
    poster: {
      url: DmitryPoster.src,
      alt: "",
      width: DmitryPoster.width,
      height: DmitryPoster.height,
    },
    videoUrl: IrinaVideo,
  },
  {
    ...
    poster: {
      url: JulyPoster.src,
      alt: "",
      width: JulyPoster.width,
      height: JulyPoster.height,
    },
    videoUrl: IrinaVideo,
  },
  {
    ...
    poster: {
      url: VladimirPoster.src,
      alt: "",
      width: VladimirPoster.width,
      height: VladimirPoster.height,
    },
    videoUrl: IrinaVideo,
  },
  {
    ...
    poster: {
      url: StasPoster.src,
      alt: "",
      width: StasPoster.width,
      height: StasPoster.height,
    },
    videoUrl: IrinaVideo,
  },
];
